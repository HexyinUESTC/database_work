...
public class goodInfoAdapter extends RecyclerView.Adapter<goodInfoAdapter.viewHolder> {
    public Context context;
    public List<HotPostBean> hotPostBeans;
    public goodInfoAdapter(Context context, List<HotPostBean> hotPostBeans) {
    ...
    @NonNull
    @Override
    public goodInfoAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = View.inflate(context, R.layout.item_hotpost, null);
        return new goodInfoAdapter.viewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final goodInfoAdapter.viewHolder holder, final int position) {
        ...
        holder.tv_hot_likes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (hotPostBean.getIsLike() == 0) {
                    ...
                    holder.tv_hot_likes.setText("￥"+hotPostBean.getLikeNum());

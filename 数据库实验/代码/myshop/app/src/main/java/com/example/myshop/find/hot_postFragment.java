...
import com.example.myshop.home.HomeFragmentAdapter;
...
public class hot_postFragment extends baseFragment {
    public final String TAG = "hot_postFragment";
    private RecyclerView recyclerView;
    private ImageButton ib_top;
    private ResultBeanData resultBeanData;
    private hot_postFragmentAdapter adapter;

    @Override
    protected View initView() {
        View view = View.inflate(getActivity(), R.layout.fragment_hot_post, null);
        recyclerView = view.findViewById(R.id.rv_home_post);
        ib_top = view.findViewById(R.id.ib_top_post);
        initListener();
        return view;
    }
...
//            有数据则设置适配器
                    adapter = new hot_postFragmentAdapter(basecontext, hotPostBeans);

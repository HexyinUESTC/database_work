...
//    }
    ...
    public HotPostBean(Integer id, Integer userId, String userName, String avator, Integer productId, String productImg, Integer commentNum, Integer likeNum, Integer sendNum, Integer isLike, Integer isSend, String description, String createTime, String updateTime, Integer version) {
        this.id = id;
        this.userId = userId;
        this.userName = userName;
        this.avator = avator;
